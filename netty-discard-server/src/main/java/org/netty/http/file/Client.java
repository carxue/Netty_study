...
import org.netty.newstudy.messagepack.MsgpackDecoder;
import org.netty.newstudy.messagepack.MsgpackEncoder;
...
//				socketChannel.pipeline().addLast(new StringDecoder());
				...
				socketChannel.pipeline().addLast(new ClientHandler2(1000));
			}
		});
